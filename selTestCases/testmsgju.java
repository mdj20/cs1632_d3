...
public class Testmsgju {
  ...
  public void testMsgju() throws Exception {
    ...
    driver.findElement(By.id("vB_Editor_001_textarea")).sendKeys("Hello World");
    driver.findElement(By.id("vB_Editor_001_save")).click();
    driver.findElement(By.cssSelector("img.inline")).click();
    driver.findElement(By.linkText("Unread Private Messages")).click();
    driver.findElement(By.cssSelector("a > strong")).click();
    assertEquals("Hello World", driver.findElement(By.id("post_message_")).getText());
    driver.findElement(By.cssSelector("img.inline")).click();
    driver.findElement(By.linkText("Unread Private Messages")).click();
