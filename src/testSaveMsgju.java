...
And when I send a user a message
I should be able to view sent message contents.
*/
...
public class testSaveMsgju {
  ...
  @Test
  public void testSaveMsgju() throws Exception {
    driver.get(baseUrl + "/");
    ...
    new Select(driver.findElement(By.name("folderid"))).selectByVisibleText("Inbox (1 Messages)");
    driver.findElement(By.id("checkall_all")).click();
